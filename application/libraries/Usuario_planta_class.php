...
class Usuario_planta_class {
    ...
    public function get_registro_campo_full($campo=null,$valor=null,$id_planta=null,$id_tipo_usu=null){  
       ...
       //if($id_tipo_usu!= null)      { $condicion += array("usuario.id_"  =>  $id_planta);  } 
        
       if($id_planta!= null)        { $condicion += array("usuario_planta.id_planta"  =>  $id_planta);  }
       if($this->excepcion!= null)  { $condicion += array("perfil.id_tipo !="  =>  $this->excepcion);  }
       
       $join       = array(                            
                            array("tabla" =>"usuario", "condicion" => "usuario_planta.id_usuario = usuario.id_usuario"),
                            array("tabla" =>"planta", "condicion" => "usuario_planta.id_planta = planta.id_planta"),
                            array("tabla" =>"perfil", "condicion" => "usuario.id_usuario = perfil.id_usuario")
                            );
